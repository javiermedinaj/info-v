  ...
  return (
    <div className="flex flex-col items-center mb-8 lg:flex-row lg:items-start">
      <motion.img
        ...
        src={image}
        alt={title}
        className="w-48 h-auto mb-4 lg:mr-4 lg:mb-0"
      />
      <div>
...
const ProductFeatures = forwardRef((props, ref) => {
  return (
    <div ref={ref} className="mx-auto py-8 px-4 bg-black">
      <p className="flex justify-center text-m-2 uppercase tracking-[8px] pb-20 text-gray-500 text-6x1">
        Características
      </p>
